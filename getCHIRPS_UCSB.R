...
# add logos
# Call back the plot
plot <- image_read(paste0("./figs/SkyIslandRegion_Monsoon_TotalPrecip.png"))
# And bring in a logo
...
image_write(final_plot, paste0("./figs/SkyIslandRegion_Monsoon_TotalPrecip.png"))
...
# write out file
png(paste0("./figs/SkyIslandRegion_Monsoon_PercPrecip.png"),
    width = 7, height = 8, units = "in", res = 300L)
#grid.newpage()
print(p, newpage = FALSE)
dev.off()
...
# add logos
# Call back the plot
plot <- image_read(paste0("./figs/SkyIslandRegion_Monsoon_PercPrecip.png"))
# And bring in a logo
#logo_raw <- image_read("./logos/UA_CLIMAS_logos.png")
logo_raw <- image_read("UA_CSAP_CLIMAS_logos_horiz.png") 
logo <- image_resize(logo_raw, geometry_size_percent(width=95,height = 95))
...
final_plot <- image_composite(plot, logo, offset = "+80+2165")
# And overwrite the plot without a logo
image_write(final_plot, paste0("./figs/SkyIslandRegion_Monsoon_PercPrecip.png"))
